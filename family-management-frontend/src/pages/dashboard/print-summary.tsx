...
export default function PrintSummary() {
  ...
  // Calculate member counts from the members array
  ...
  // Use type-safe access for stored values
  const storedTotalMembers = (fam && typeof fam === 'object' && 'totalMembers' in fam) ? fam.totalMembers : 0;
  const storedNumMales = (fam && typeof fam === 'object' && 'numMales' in fam) ? fam.numMales : 0;
  const storedNumFemales = (fam && typeof fam === 'object' && 'numFemales' in fam) ? fam.numFemales : 0;
